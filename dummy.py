...
st.set_page_config(page_title="NutriVision", page_icon="🍏")

# Define anchor IDs and icons
anchor_ids = ["About", "Features", "Vision", "Login", "Contact"]
...
# Vision Section
st.subheader("Vision", anchor="Vision")
st.markdown("""
    <div style="margin-bottom: 20px;">
        <p>
            Our vision is to empower individuals to take control of their health and nutrition 
            through advanced technology and personalized support. We believe that everyone deserves 
            access to accurate nutritional information and the tools to make informed dietary choices.
        </p>
        <br>
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div style="margin-bottom: 20px;">
        ...
        <div>
            ...
            <input type="password" id="password" placeholder="Your Password" style="width: 100%; margin-bottom: 10px;">
            <button style="background-color: #008000; color: white; padding: 10px; border: none; border-radius: 5px;">Login</button>
        </div>
        <br>
    </div>
""", unsafe_allow_html=True)
